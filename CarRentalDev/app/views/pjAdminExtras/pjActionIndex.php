...
if (isset($tpl['status']))
{
	...
	<?php pjUtil::printNotice(__('infoExtrasTitle', true), __('infoExtrasBody', true)); ?>
	<?php
	...
	var myLabel = myLabel || {};
	myLabel.extra_title = "<?php __('extra_title'); ?>";
	myLabel.extra_price = "<?php __('extra_price'); ?>";
	myLabel.extra_count = "<?php __('extra_count'); ?>";
