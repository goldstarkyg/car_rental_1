...
if (isset($tpl['arr']) && !empty($tpl['arr']))
{
	...
	<form action="" method="post" class="form pj-form">
		...
		<p>
			<label><b><?php __('lblCustomerEmail');?>:</b> <input type="hidden" name="to" value="<?php echo pjSanitize::html($tpl['arr']['client_email']); ?>"/> <?php echo pjSanitize::html($tpl['arr']['client_email']); ?></label>
		</p>
		<?php endif; ?>
	</form>
	<?php
