...
INSERT INTO `fields` VALUES (NULL, 'btnAddReservation', 'backend', 'Button / + Add reservation', 'script', '2015-11-19 06:45:02');

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', '+ Add reservation', 'script');

INSERT INTO `fields` VALUES (NULL, 'btnAddLocation', 'backend', 'Button / + Add location', 'script', '2015-11-19 07:12:24');

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', '+ Add location', 'script');

INSERT INTO `fields` VALUES (NULL, 'btnAddCar', 'backend', 'Button / + Add car', 'script', '2015-11-19 07:35:17');

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', '+ Add car', 'script');

INSERT INTO `fields` VALUES (NULL, 'btnAddUser', 'backend', 'Button / + Add user', 'script', '2015-11-19 07:44:07');
