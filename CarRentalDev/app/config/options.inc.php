...
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "2.1.1");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale',  'pjLog', 'pjInstaller', 'pjOneAdmin','pjBackup', 'pjPaypal', 'pjAuthorize', 'pjCountry', 'pjSms');
?>